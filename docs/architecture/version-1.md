...
Physical dimensions of the baseline components are measured and recorded in
[`Measurements/`](../../Measurements/README.md), which is canonical. Measured values
override generic online dimensions, and unclear or missing dimensions are tracked in
